...
GO
PRINT N'Altering Table [dbo].[Avaliacao]...';


GO
ALTER TABLE [dbo].[Avaliacao] ALTER COLUMN [DataAvaliacao] NVARCHAR (50) NULL;


GO
PRINT N'Altering Table [dbo].[Episodio]...';


GO
ALTER TABLE [dbo].[Episodio] ALTER COLUMN [DataLancamento] NVARCHAR (50) NULL;
