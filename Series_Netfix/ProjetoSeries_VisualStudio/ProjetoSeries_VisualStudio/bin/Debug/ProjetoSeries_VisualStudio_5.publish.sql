...
CREATE TABLE [dbo].[ClassificacaoEtaria] (
    ...
    [FaixaClassificacao]    VARCHAR (100) NULL,
...
CREATE TABLE [dbo].[Episodio] (
    ...
    [NomeEpisodio]   VARCHAR (100) NOT NULL,
...
CREATE TABLE [dbo].[IdiomaDublado] (
    ...
    [NomeIdiomaDublado] VARCHAR (100) NULL,
    [Ativo]             BIT           NULL,
...
CREATE TABLE [dbo].[IdiomaLegendado] (
    ...
    [NomeIdiomaLegendado] VARCHAR (100) NULL,
    [Ativo]               BIT           NULL,
...
CREATE TABLE [dbo].[Serie] (
    [IdSerie]               INT           IDENTITY (1, 1) NOT NULL,
    [IdDiretor]             INT           NULL,
    [IdProdutora]           INT           NULL,
    [IdPaisOrigem]          INT           NULL,
    [IdClassificacaoEtaria] INT           NULL,
    [Ativo]                 BIT           NULL,
...
CREATE TABLE [dbo].[Serie_Legendado] (
    [IdSerie]           INT NOT NULL,
    [IdIdiomaLegendado] INT NOT NULL,
